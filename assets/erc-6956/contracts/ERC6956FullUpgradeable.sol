...
contract ERC6956FullUpgradeable is ERC721Upgradeable, ERC721BurnableUpgradeable, ERC6956FullBase, UUPSUpgradeable
{
    function initialize(string memory name, string memory symbol, AttestationLimitPolicy _limitUpdatePolicy) public initializer {
...
/**
    ...
    function _authorizeUpgrade(address newImplementation) internal override onlyMaintainer() {}
     ...
     function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC6956FullBase, ERC721Upgradeable)
        returns (bool) {
            return ERC6956FullBase.supportsInterface(interfaceId) || ERC721Upgradeable.supportsInterface(interfaceId);
        }
}
